...
bq rm -t ml_dataset.bigdata_tmp
bq mk -t --schema ./schema/tmp.json ml_dataset.bigdata_tmp
bq query --use_legacy_sql=false 'delete from `ml_dataset.bigdata_tmp` where id !=-1 '
bq query --use_legacy_sql=false  < gen_bigdata_tmp.sql
